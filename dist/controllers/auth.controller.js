    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!email || !password) {
                    return [2 /*return*/, next(new utils_1.AppError(Message_1.default.PROVIDE_EMAIL_AND_PASSWORD, 400))];
                }
                _c.label = 1;
            case 1:
                _c.trys.push([1, 5, , 6]);
            ...
            case 4:
                if (_b) {
                    return [2 /*return*/, next(new utils_1.AppError(Message_1.default.INVALID_EMAIL_OR_PASSWORD, 401))];
                }
                else {
                    token = (0, utils_2.jwtGenerator)(user._id);
                    res.status(200).json({

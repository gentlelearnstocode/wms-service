...
exports.updateProduct = exports.getProduct = exports.getAllProducts = exports.createProduct = void 0;
...
var createProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.ProductModel.create(req.body)];
            case 1:
                product = _a.sent();
                res.status(201).json({
...
var getProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models_1.ProductModel.findById(req.params.id).populate('warehouse')];
            case 1:
                product = _a.sent();
                if (!product) {
                    return [2 /*return*/, next(new AppError_1.AppError("No product found with this ID: ".concat(req.params.id), 404))];
                }
                res.status(200).json({
                    status: Status_1.default.SUCCESS,
                    data: {
...
var updateProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.ProductModel.findByIdAndUpdate({ _id: req.params.id }, req.body, {
                        runValidators: true,
                        new: true,
                    })];
            case 1:
